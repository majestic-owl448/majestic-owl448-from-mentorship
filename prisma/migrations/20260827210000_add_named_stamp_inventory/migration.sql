...
INSERT INTO "new_stamp_inventory_entries" (
    ...
    "manual_postage_currency_code", "name", "postal_entity_id",
    "quantity_annulled", "quantity_owned", "updated_at", "user_id",
    "year_of_issue"
)
SELECT
    "country_code", "created_at", "expired", "face_amount",
...
CREATE UNIQUE INDEX "named_face_values_id_country_code_key" ON "named_face_values"("id", "country_code");
