...
CREATE TABLE "named_face_value_definition_proposals" (
    ...
    CONSTRAINT "named_face_value_definition_proposals_submitted_by_id_fkey" FOREIGN KEY ("submitted_by_id") REFERENCES "user_profiles" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE "named_face_value_value_proposals" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "submitted_by_id" TEXT NOT NULL,
    ...
    "status" TEXT NOT NULL DEFAULT 'PENDING',
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "named_face_value_value_proposals_submitted_by_id_fkey" FOREIGN KEY ("submitted_by_id") REFERENCES "user_profiles" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO "new_stamp_inventory_entries" (
    ...
    "user_id", "year_of_issue", "face_value_type"
)
SELECT
    "country_code", "created_at", "expired", "face_amount",
    "face_currency_code", "id", "manual_postage_amount",
